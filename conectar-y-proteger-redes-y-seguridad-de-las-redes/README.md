...
---
Este curso ofrece una breve introducción a la arquitectura de redes, las operaciones, las tácticas de intrusión y el endurecimiento de la seguridad.
   - Los alumnos también conocerán los protocolos de red más comunes y cómo los sistemas utilizan el Modelo TCP/IP para comunicarse dentro de una red.
   - Los alumnos comprenderán las vulnerabilidades a nivel de red y cómo proteger una red contra dichas vulnerabilidades
   - Los temas de Seguridad de red incluirán
      - cortafuegos
      - redes privadas virtuales (VPNs)
      - endurecimiento del sistema
      - redes privadas virtuales.
   - Al final de este curso, usted podrá:
      - Describir la estructura de diferentes redes informáticas.
      - Ilustrar cómo se envían y reciben datos a través de una red.
      - Reconocer protocolos de red comunes.
      - Identificar medidas y protocolos de seguridad de red comunes.
      - Explicar cómo asegurar una red contra tácticas de intrusión.
      - Comparar y contrastar las redes locales con la computación en la nube.
      - Explicar los diferentes tipos de técnicas de endurecimiento del sistema.
...
## Citas
---
- [Meyers, Mike, y Scott Jernigan. (2019) CompTIA A+ Certification All-in-One Exam Guide, (Exámenes 220-1001 & 220-1002)](https://books.google.cl/books/about/CompTIA_A+_Certification_All_in_One_Exam.html?id=9C-NDwAAQBAJ&redir_esc=y)
- [Oluwatosin, H.S. (2014). Modelo cliente-servidor. IOSR Journal of Computer Engineering, 16(1), 67-71](https://www.researchgate.net/publication/271295146_Client-Server_Model)
- [Sulyman, Shakirat. (2014). Modelo cliente-servidor. Revista IOSR de Ingeniería Informática. 16. 57-71. 10.9790/0661-16195771](https://www.researchgate.net/publication/271295146_Client-Server_Model)
- [GeeksforGeeks. (2022, 21 de marzo).Dispositivos utilizados en cada capa del Modelo TCP/IP.](https://www.geeksforgeeks.org/devices-used-in-each-layer-of-tcp-ip-model/)
- [Centros de datos Colo de Rackspace Technology. (s.f.). ¿Qué es la colocación?](https://www.rackspace.com/library/what-is-colocation)
- [Fortinet. (s.f.) ¿Qué es la nube híbrida?](https://www.fortinet.com/resources/cyberglossary/what-is-hybrid-cloud)
- [Clarke, Glen E. (2018). Guía de estudio de la certificación CompTIA Network+: Examen N10-007.](https://www.amazon.com/CompTIA-Network-Certification-Guide-Exam/dp/1260122380)
- [International Business Machines. (s.f.). Protocolo de datagramas de usuario.](https://www.ibm.com/docs/en/aix/7.2?topic=protocols-user-datagram-protocol)
- [International Business Machines. (2022, Nov 15) Protocolo de control de transmisión.](https://www.ibm.com/docs/en/aix/7.2?topic=protocols-transmission-control-protocol)
- [Oracle. (s.f.). Modelo de arquitectura del protocolo TCP/IP. Guía de administración del sistema, volumen 3.](https://docs.oracle.com/cd/E19683-01/806-4075/ipov-10/index.html)
- [Estudio CCNA. (s.f.).Modelos OSI y TCP/IP.](https://study-ccna.com/osi-tcp-ip-models/)
- [Cloudflare. (s.f.) ¿Qué es el Modelo OSI?](https://www.cloudflare.com/learning/ddos/glossary/open-systems-interconnection-model-osi/)
- [FreeCodeCamp. (2020, 21 de diciembre). El Modelo OSI - Las 7 Capas de Red Explicadas en Inglés Sencillo.](https://www.freecodecamp.org/news/osi-model-networking-layers-explained-in-plain-english/)
- [Imperva. (s.f.). Modelo OSI. Seguridad de las aplicaciones.](https://www.imperva.com/learn/application-security/osi-model/#:~:text=The%20session%20layer%20creates%20communication,closing%20them%20when%20communication%20ends)
- [Rajinder Kaur (2009) Cabecera IPv4. Tecnologías avanzadas de Internet.](https://advancedinternettechnologies.wordpress.com/ipv4-header/)
- [Gsephrioth. (2017). El diagrama IP.](https://gsephrioth.github.io/Ch8-IP-Datagram/)
- [Robert Wright. (n.d.). IP Routing Primer. O'Reilly.](https://www.oreilly.com/library/view/ip-routing-primer/1578701082/1578701082_ch08lev1sec3.htm)
- [Agnė Srėbaliūtė. (2022, 2 de agosto). Encabezado de paquetes IPv4: Formato y estructura. IPXO.](https://www.ipxo.com/blog/ipv4-packet-header/)
- [Instituto Nacional de Normas y Tecnología. (Glosario).](https://csrc.nist.gov/glossary)
- [Cloudflare. (s.f.).¿Qué es un protocolo?](https://www.cloudflare.com/learning/network-layer/what-is-a-protocol/)
- [CompTIA. (s.f.). ¿Qué es un protocolo de red y cómo funciona?](https://www.comptia.org/content/guides/what-is-a-network-protocol)
- [IBM. (2022, Oct 17). Asignación de direcciones y parámetros TCP/IP - Protocolo de configuración dinámica de host. Documentación de IBM AIX.](https://www.ibm.com/docs/en/aix/7.1?topic=tcpp-tcpip-address-parameter-assignment-dynamic-host-configuration-protocol)
- [Microsoft. (n.d.O). ¿Qué son IMAP y POP? Soporte de Microsoft.](https://support.microsoft.com/en-us/office/what-are-imap-and-pop-ca2c5799-49f9-4079-aefe-ddca85d5b1c9)
- [Microsoft. (2013, 21 de octubre). SMTP.](https://learn.microsoft.com/en-us/previous-versions/office/developer/exchange-server-2010/aa494182(v=exchg.140))
- [Asus. (2022, 14 de enero). [Wireless] ¿Qué es WPA3? ¿Cuáles son las ventajas de utilizar WPA3? Preguntas frecuentes.](https://www.asus.com/support/FAQ/1042478/)
- [Britannica, T. Editores de la Enciclopedia (2022, 3 de febrero). Wi-Fi. Enciclopedia Británica.](https://www.britannica.com/technology/Wi-Fi)
- [Cisco Press. (2010, 9 de abril). Cómo pasar al cifrado WPA/WPA2-Enterprise wi-fi.](https://www.ciscopress.com/articles/article.asp?p=1576225)
- [Cisco. (s.f.). ¿Qué es un cortafuegos? ](https://www.cisco.com/c/en/us/products/security/firewalls/what-is-a-firewall.html)
- [Cloudflare. (s.f.) ¿Qué es una subred?](https://www.cloudflare.com/learning/network-layer/what-is-a-subnet/)
- [Techopedia. (2017, 18 de julio). Subnetting. Diccionario.](https://www.techopedia.com/definition/28328/subnetting)
- [Guía de direcciones IP. (s.f.). Conversión de CIDR a IPv4. Herramientas IPV4. servidores proxy](https://www.ipaddressguide.com/cidr)
- [Vinton, Kate. (2014, 18 de septiembre). Con 56 millones de tarjetas comprometidas, la brecha de Home Depot es mayor que la de Target. Forbes.](https://www.forbes.com/sites/katevinton/2014/09/18/with-56-million-cards-compromised-home-depots-breach-is-bigger-than-targets/?sh=1514b8a53e74)
- [Olenick, D. (2020, 10 de diciembre) Declaración de culpabilidad en el ataque de DDoS a Dyn de 2016. Seguridad de la información bancaria .](https://www.bankinfosecurity.com/guilty-plea-in-2016-dyn-ddos-attack-a-15567#:~:text=Federal%20prosecutors%20estimate%20the%20attack,million%20due%20to%20the%20attack.)
- [Young, K (2022, 10 de enero) Estudio de un caso cibernético: El ataque de denegación de servicio distribuido (DDoS) Mirai contra Dyn . Coverlink.](https://coverlink.com/case-study/mirai-ddos-attack-on-dyn/#:~:text=On%20Oct.,systems%20and%20overwhelm%20its%20infrastructure)
- [Engebretson, P. (2013). The basics of hacking and penetration testing: ethical hacking and penetration testing made easy. Elsevier.](https://www.sciencedirect.com/book/monograph/9780124116443/the-basics-of-hacking-and-penetration-testing)
- [Instituto Nacional de Tecnología de la Seguridad. (2018, octubre). Guía de seguridad de sistemas macOS 10.12 para profesionales de TI. Publicación especial 800-179, revisión 1.](https://csrc.nist.gov/CSRC/media/Publications/sp/800-179/rev-1/draft/documents/sp800-179r1-draft.pdf)
- [Cybertalk. (2021, 12 de noviembre). Qué es el tailgating y por qué es importante.](https://www.cybertalk.org/2021/11/12/tailgating-social-engineering-attacks-what-is-tailgating-and-why-it-matters/)
- [Gite, V. (2022). 40 Linux server hardening security tips [Edición 2021]. Ciber Citi.](https://www.cyberciti.biz/tips/linux-security.html)
- [Richardson, Maryann. (2002, 15 de julio). Mejore la seguridad de su Linux: Detenga los servicios innecesarios . TechRepublic.](https://www.techrepublic.com/article/improve-your-linux-security-stop-unnecessary-services/)
- [Carrigan, Tyler. (2020, 18 de mayo). Conexión en red Linus: 13 usos para netstat. Redhat.](https://www.redhat.com/sysadmin/netstat)
