...
Los alumnos también explorarán los ocho dominios de seguridad del Profesional Certificado en Seguridad de Sistemas de Información (CISSP), los marcos y controles de seguridad comunes, así como la tríada de confidencialidad, integridad y disponibilidad (CID).

Este curso cubre una amplia variedad de temas de ciberseguridad para proporcionar una visión general de lo que está por venir en este programa de certificación. Los alumnos que completen los ocho cursos del Certificado en Ciberseguridad de Google estarán preparados para solicitar puestos de ciberseguridad de nivel básico. No es necesaria experiencia previa.

Al finalizar este curso, podrás - Identificar cómo los ataques de seguridad afectan a las operaciones de negocio - Explorar las responsabilidades del trabajo y las habilidades básicas de un analista de ciberseguridad de nivel de entrada - Reconocer cómo los ataques pasados y presentes en las organizaciones llevaron al desarrollo del campo de la ciberseguridad - Aprender los ocho dominios de seguridad CISSP - Identificar los dominios de seguridad, marcos y controles - Explicar la ética de la seguridad - Reconocer las herramientas comunes utilizadas por los analistas de ciberseguridad.
...
## Recursos del curso
---
- [Recursos útiles para empezar](https://www.coursera.org/learn/linux-and-sql/supplement/9G5J5/helpful-resources-to-get-started)
- [Google: Problemas comunes con los laboratorios](https://support.google.com/qwiklabs/answer/9133560?hl=en&ref_topic=9134804)
- [Ayuda de Google Docs](https://support.google.com/docs/topic/9046002?hl=en&ref_topic=1382883)
- [Ayuda de Google Sheets](https://support.google.com/docs/topic/9054603?hl=en&ref_topic=1382883)
- [Cómo utilizar Google Slides](https://support.google.com/docs/answer/2763168?hl=en&co=GENIE.Platform%3DDesktop)
- [Ayuda y aprendizaje de Microsoft Excel](https://support.microsoft.com/en-us/excel)
- [Ayuda y formación sobre PowerPoint](https://support.microsoft.com/en-us/powerpoint)
- [Ayuda y formación sobre Word](https://support.microsoft.com/en-us/word)
- [Youtube: Hacking Google series](https://www.youtube.com/playlist?list=PL590L5WQmH8dsxxz7ooJAgmijwOz0lh2H)
- [Glosario del Instituto de Normas y Tecnología (NIST)](https://csrc.nist.gov/glossary/term/nist)
- [Servicios y herramientas de ciberseguridad gratuitos](https://www.cisa.gov/free-cybersecurity-services-and-tools)
- [Informe horizonte de amenazas](https://services.google.com/fh/files/blogs/gcat_threathorizons_full_sept2022.pdf)
- [Sintaxis básica Markdown](https://www.markdownguide.org/basic-syntax/)
- [Hoja de trucos Markdown de GitHub](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)
