...
- Conocerán el lenguaje de programación Python y aprenderán a aplicarlo a un entorno de seguridad para automatizar tareas.
- En primer lugar, los alumnos se centrarán en los conceptos básicos de programación de Python, incluidos los tipos de datos, las variables, las sentencias condicionales y las sentencias iterativas.
- A continuación, aprenderán a trabajar eficazmente con Python mediante el desarrollo de funciones, el uso de bibliotecas y módulos y la legibilidad del código.
- A continuación, explorarán el trabajo con cadenas y listas de datos.
- Un componente final de aprender a automatizar tareas a través de Python será una exploración de cómo importar y analizar archivos, y luego el curso concluirá con un enfoque en la depuración.
- Al final de este curso, usted podrá:
   ...
   - Crear nuevas funciones Python definidas por el usuario.
   - Utilizar Python para trabajar con cadenas y listas.
   - Utilizar expresiones regulares para extraer información de un texto.
   - Utilizar Python para abrir y leer el contenido de un archivo.
   - Identificar las mejores prácticas para mejorar la legibilidad del código.
...
- `Conditional statement`: A statement that evaluates code to determine whether it meets a specified set of conditions
...
## Recursos del curso
---
- [Python: Funciones incorporadas](https://docs.python.org/3/library/functions.html)
- [Pep 8 - Guía de estilo para el código Python](https://peps.python.org/pep-0008/)

## Citas
---
- [Proyecto jupyter. (s.f.). Proyecto Jupyter.](https://jupyter.org/about)
- [Python. (2023, 9 de febrero). Documentación de The Python Standard Library-Python 3.10.7.](https://docs.python.org/3/library/)
- [NumPy. (s.f.). Sobre nosotros.](https://numpy.org/about/)
- [Crummy.(s.f.). Documentación de Beautiful Soup. Documentación de Beautiful Soup 4.9.0. (s.f.).](https://www.crummy.com/software/BeautifulSoup/bs4/doc/)
- [van Rossum, G., Warsaw, B., & Coghlan, N. (2001). PEP 8 - Guía de estilo para el código Python. Índice Pep.](https://peps.python.org/pep-0008/)
