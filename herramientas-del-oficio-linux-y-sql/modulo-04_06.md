# ¡Enhorabuena por haber completado el Curso 4!

## Reflexionar y conectar con los compañeros
- Enhorabuena por completar el curso Herramientas del oficio: Linux y SQL 
- Has aprendido Linux y SQL, que te ayudarán a gestionar servidores, investigar incidencias y analizar datos.
- [Únete a la comunidad de ciberseguridad](https://www.coursera.support/s/group-invite?id=MEY5VkgwMDAwMDAwMWMxMEFB)

---

## Resumen del curso
- ​Recapitulemos lo que ha aprendido en este curso.
- ​Nos centramos primero en los sistemas operativos ​y en cómo se relacionan con las aplicaciones y el hardware.
